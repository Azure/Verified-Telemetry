...
{
  VT_FLOAT falltime_deviation = (abs_custom((VT_FLOAT)falltime_under_test - (VT_FLOAT)falltime_saved)/(VT_FLOAT)falltime_saved) * 100.0f;
...
{
  VT_FLOAT pearson_coeff_deviation = (abs_custom(pearson_coeff_under_test - pearson_coeff_saved)/pearson_coeff_saved) * 100.0f;
...
VT_UINT fc_signature_evaluate(VT_ULONG falltime_under_test, VT_ULONG falltime_saved, VT_FLOAT pearson_coeff_under_test, VT_FLOAT pearson_coeff_saved)
{
