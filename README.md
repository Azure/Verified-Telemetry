...
| [nx_vt_signature_read](https://azure.github.io/Verified-Telemetry/nx__verified__telemetry_8h.html) | Starts reading VT signatures for the sensor mapped to the telemetry string passed |
| [nx_vt_signature_process](https://azure.github.io/Verified-Telemetry/nx__verified__telemetry_8h.html) | Processes the collected VT signatures for the sensor mapped to the telemetry string passed |
...
* Define scratch buffer of length VT_RECOMMENDED_BUFFFER_SIZE_BYTES (2500 bytes). Thus buffer would be used by the library to store runtime signatures
