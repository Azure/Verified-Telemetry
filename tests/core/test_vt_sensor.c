...
// clang-format off
static uint32_t fingerprint_array[2][VT_FINGERPRINT_LENGTH] = 
{
    {0,10,19,29,39,49,58,68,77,86,96,105,114,123,131,140,149,157,166,174,182,191,199,207,215,223,230,238,246,253,261,268,276,283,290,297,304,311,318,325,332,339,345,352,358,365,371,377,384,390,396,402,408,414,420,426,432,437,443,448,454,459,465,470,476,481,486,491,496,501,506,511,516,521,526,531,535,540,545,549,554,558,563,567,571,576,580,584,588,593,597,601,605,609,613,616,620,624,628,632},
...
static void test_vt_sensor_initialize(void** state)
{
    ...
    assert_int_equal(vt_sensor_initialize(&test_sensor,
                         "this_is_a_very_long_sensor_name_which_should_be_greater_than_max_sensor_name_length",
                         NULL,
                         7,
                         NULL,
                         2,
...
uint32_t __wrap__vt_dsc_adc_read(ADC_CONTROLLER_TYPEDEF* adc_controller, ADC_CHANNEL_TYPEDEF adc_channel, uint32_t* value)
{
