...
static VT_UINT vt_adc_single_read_step_going_to_zero_voltage_response(
...
static VT_UINT vt_adc_single_read_fast_exponential_fall_voltage_response(
    VT_UINT adc_id, VT_VOID* adc_controller, VT_VOID* adc_channel)
{
    VT_UINT value = 0;
...
static VT_UINT vt_adc_single_read_slow_exponential_fall_voltage_response(
    VT_UINT adc_id, VT_VOID* adc_controller, VT_VOID* adc_channel)
{
    VT_UINT value = 0;
    value = round((VT_FLOAT)1000 * (VT_FLOAT)exp(-1.0f * ((VT_FLOAT)vt_adc_iter / (VT_FLOAT)((VT_FC_SAMPLE_LENGTH * 3) - 1))));
